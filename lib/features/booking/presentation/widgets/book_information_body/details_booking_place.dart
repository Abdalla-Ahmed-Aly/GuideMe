...
import 'package:guide_me/features/booking/presentation/widgets/success_book_body/success_massage.dart';

class DetailsBookingPlace extends StatefulWidget {
  const DetailsBookingPlace({super.key});

  @override
  State<DetailsBookingPlace> createState() => _DetailsBookingPlaceState();
}

class _DetailsBookingPlaceState extends State<DetailsBookingPlace> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 19.p, top: 9.p),
                child: Text(
                  'Overview',
