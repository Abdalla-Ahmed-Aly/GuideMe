          ...
          children: [
            Expanded(
              child: BookingDetailsRequestItem(
                ...
                value: 'Oct 24, 2026',
                value1: '9:00 AM',
                pathicon: SvgPicture.asset(AppIcons.date, width: 24.w),
              ),
            ),
            SizedBox(
              width: 20.w,
            ...
            Expanded(
              child: BookingDetailsRequestItem(
                ...
                value: '4 Hours',
                value1: 'Flexible end',
                pathicon: SvgPicture.asset(AppIcons.time, width: 24.w),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: BookingDetailsRequestItem(
                ...
                value: '4 People',
                value1: 'Privet Group',
                pathicon: SvgPicture.asset(AppIcons.people, width: 24.w),
              ),
            ),
            SizedBox(
              width: 20.w,
            ...
            Expanded(
              child: BookingDetailsRequestItem(
                ...
                pathicon: SvgPicture.asset(AppIcons.location, width: 24.w),
              ),
            ),
          ],
        ),
